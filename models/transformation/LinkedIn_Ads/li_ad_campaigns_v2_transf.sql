...
with li_ads_ad_analytics_by_campaign_raw as (
    ...
    SELECT 
        ...
        one_click_leads AS leads, CAST(IF ((one_click_leads) > 0,(cost_in_usd)/(one_click_leads),0) AS NUMERIC) AS CPL,comments, CAST (likes AS NUMERIC) AS likes,shares, total_engagements
